...
class BigGAN_128(object):
    ...
    def __init__(self, sess, args):
        ...
        elif self.dataset_name == "cifar10_6":
            self.c_dim = 3
            self.data = load_cifar10_6()
    ...
    def build_model(self):
        ...
        inputs = inputs.\
            ...
            apply(map_and_batch(Image_Data_Class.image_processing, self.batch_size, num_parallel_batches=4, drop_remainder=True)).\
    ...
    def loadAllCkpt(self, path, checkpoint_dir):
        if path:
    ...
    def test(self):
        ...
        for path in ckpt.all_model_checkpoint_paths:
            print(path)
            could_load, checkpoint_counter = self.loadAllCkpt(path, checkpoint_dir)
            result_dir = os.path.join(self.result_dir, self.model_dir)
            result_dir = os.path.join(result_dir, str(checkpoint_counter))
            ...
            for i in range(self.test_num):
                ...
                save_images(samples[:image_frame_dim * image_frame_dim, :, :, :],
                            ...
                            result_dir + '/' + self.model_name + '_test_' + str(checkpoint_counter) +'_{}.png'.format(i))