...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='groundTruth1', help='[mnist / cifar10 / custom_dataset / sampledData / cifar10_6]')

    parser.add_argument('--epoch', type=int, default=300, help='The number of epochs to run')
    parser.add_argument('--iteration', type=int, default=751, help='The number of training iterations')
    ...
    parser.add_argument('--print_freq', type=int, default=200, help='The number of image_print_freqy')
    ...
    parser.add_argument('--d_lr', type=float, default=0.00001, help='learning rate for discriminator')
    ...
    parser.add_argument('--test_num', type=int, default=2048, help='The number of images generated by the test')
